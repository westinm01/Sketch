...
public class ArtblockMovement : EnemyMovement
{
    public float slideSpeed = 2;
    public float jumpHeight = 2;
    protected Animator artblockAnim;
    ...
    {
        base.Start();
        artblockAnim = gameObject.GetComponent<Animator>();
    ...
    protected override void Update()
    {
        ...
        if (gameObject.GetComponent<EnemyCombat>().isStunned()){
            ...
            moveSpeed = maxSpeed;
            if (level == 1){
                artblockAnim.Play("artblock1move");
            }
            else if (level == 2){
                artblockAnim.Play("artblock2jump");
            }
