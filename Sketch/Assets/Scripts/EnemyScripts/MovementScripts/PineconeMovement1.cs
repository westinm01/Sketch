...
public class PineconeMovement1 : EnemyMovement
{
    ...
    protected void moveTowardsPlayer()
    {
        ...
        if (canJump) enemyRigidBody.velocity = new Vector2(direction, jumpHeight);
        else enemyRigidBody.velocity = new Vector2(direction, enemyRigidBody.velocity.y);
        slideTimer = 0;
    }
